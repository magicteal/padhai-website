    ...
    <section className="py-16 px-4 bg-gradient-to-br from-purple-600 to-purple-700">
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-3xl p-10 shadow-2xl">
          <div className="inline-block bg-yellow-400 text-yellow-900 px-4 py-2 rounded-full font-bold text-sm mb-6">
            ⚡ January Launch Offer (Limited Seats)
          </div>
          ...
          <button className="w-full bg-purple-600 text-white font-bold text-xl py-5 rounded-full hover:bg-purple-700 transition shadow-lg mb-4">
